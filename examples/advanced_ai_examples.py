...
""",
    ...
    print(f"Code review prompt generated")
    ...
    from core.advanced_ai import PromptTemplate, PromptType
    ...
    print(f"Imported templates into new library")
...
Now classify: {text}""",
    ...
    sentiment_prompt = library.render(
        "sentiment_few_shot",
        text="This is absolutely amazing!"
    )
    
    print(f"Few-shot prompt created for sentiment analysis")
