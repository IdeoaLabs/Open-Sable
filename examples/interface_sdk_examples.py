...
async def main():
    ...
    print(f"  - USER_CONNECTED")
    print(f"  - USER_DISCONNECTED")
    print(f"  - ERROR")
    ...
    await sdk.emit(InterfaceEvent.MESSAGE_RECEIVED, {"content": "Test message", "sender": "user_123"})
    ...
    api_interface = InterfaceSDK(
        ...
        config={
            ...
            "endpoints": {
                ...
                "receive": "/api/v1/messages/{id}"
            }
        }
    )
    
    print(f"REST API configuration:")
    ...
    for i in range(10):
        await sdk.emit(
            ...
            {"content": f"Message {i}", "sender": f"user_{i % 3}"}
        )
    
    metrics = sdk.get_metrics()
    
    print(f"Interface metrics:")
