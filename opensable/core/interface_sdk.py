...
class CustomCLIInterface(InterfaceLifecycle):
    ...
    async def start(self):
        ...
        self.is_running = True
        await self.emit_event("started")
        print(f"CLI interface started. Type 'exit' to quit.")
                ...
                if spec and spec.loader:
                    ...
                    for name, obj in inspect.getmembers(module):
                        if (inspect.isclass(obj) and
                            issubclass(obj, InterfaceLifecycle) and
                            obj != InterfaceLifecycle):
...
async def main():
    ...
    if ws_interface:
        ...
        # Send test message
        test_msg = InterfaceBuilder.create_message(
