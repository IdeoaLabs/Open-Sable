...
class OnboardingWizard:
    ...
    async def _configure_personality(self):
        ...
        personalities = {
            ...
            "3": {
                "name": "Technical",
                "description": "Precise, detailed, developer-oriented"
            },
            "4": {
                "name": "Creative",
                "description": "Innovative, expressive, artistic"
            },
            "5": {
                "name": "Sarcastic",
                "description": "Witty, humorous, with attitude"
            }
        }
    ...
    async def _install_skills(self):
        ...
        if recommended:
            print(f"Based on your use case, we recommend these skills:")
