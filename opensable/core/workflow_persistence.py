...
class WorkflowEngine:
    ...
    def __init__(
        ...
        """
        self.storage_dir = Path(storage_dir) if storage_dir else Path.home() / ".opensable" / "workflows"
            ...
            try:
                ...
                if step.timeout:
                    step_result = await asyncio.wait_for(
                        handler(**step.params, context=context),
    ...
    async def _resume_from_checkpoint(
        ...
        remaining_steps = [
            ...
            if step.id not in checkpoint.completed_steps
        ]
...
class WorkflowLibrary:
    ...
    def __init__(self, storage_dir: Optional[str] = None):
        ...
        self.storage_dir = Path(storage_dir) if storage_dir else Path.home() / ".opensable" / "workflow_templates"
        self.storage_dir.mkdir(parents=True, exist_ok=True)
