...
class VoiceCallHandler:
    ...
    def __init__(self, config: Config):
        ...
        # Call settings
        self.greeting_message = getattr(config, 'voice_greeting', 
                                       "Hello, this is Open-Sable AI assistant. How can I help you?")
        self.goodbye_message = getattr(config, 'voice_goodbye',
