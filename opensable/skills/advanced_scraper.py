...
class AdvancedScraper:
    ...
    async def navigate(self, url: str, wait_until: str = 'networkidle') -> Page:
        ...
        self._record_action(ScrapingAction(
        ...
        try:
            ...
            for action in recipe.actions:
                ...
                if action.screenshot:
                    screenshot_path = self.recipes_dir / f"{recipe.name}_{datetime.now().isoformat()}.png"
    ...
    def list_recipes(self) -> List[str]:
        ...
        recipes = [
            p.stem
            for p in self.recipes_dir.glob("*.json")
        ]
        return recipes
