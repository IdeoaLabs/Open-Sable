...
class EmailSkill:
        ...
        try:
            ...
            if not creds or not creds.valid:
                if creds and creds.expired and creds.refresh_token:
                    ...
                    logger.warning("Gmail credentials not found. Email skill will run in demo mode.")
                    return
    ...
    async def read_emails(self, max_results: int = 10, unread_only: bool = True) -> List[Dict[str, Any]]:
        """Read recent emails"""
        if not self.service:
