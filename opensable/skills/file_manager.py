...
class FileManager:
    ...
    def __init__(self, storage_dir: Optional[str] = None):
        ...
        """
        self.storage_dir = Path(storage_dir) if storage_dir else Path.home() / ".opensable" / "files"
...
async def main():
    ...
    file_info = await fm.upload_file(str(test_file), "uploads/test.txt", progress_callback=progress_callback)
